...
#define STRING_VERSION_CONFIG_H  "(V1.1, 14/01/2014 - inverted extruder - adjusted offset) "  // build date and time
#define STRING_CONFIG_H_AUTHOR "(Jonas Schwarz, printMATE_V1.1 config)" //Who made the changes.
...
#define X_MAX_POS 200 // (this is the print area, without the glass when printing directly on the HBP sheet it can be expanded to 214mm)
#define X_MIN_POS 0
#define Y_MAX_POS 190 // (this is the print area, without the glass when printing directly on the HBP sheet it can be expanded to 214mm)
#define Y_MIN_POS 0
#define Z_MAX_POS 200 // ( it is recommended to print only up to 150mm with the delivered filament holder)
#define Z_MIN_POS 0
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,767}  // default steps per unit for ultimaker
